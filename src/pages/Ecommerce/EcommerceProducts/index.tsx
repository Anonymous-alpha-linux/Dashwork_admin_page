...
const EcommerceProducts = () => {
  ...
  const toggleTab = (tab: string, type: "all" | "published" | "draft") => {
    if (activeTab !== tab) {
      setActiveTab(tab);
  ...
  */
  ...
  const columns = useMemo<ColumnDef<typeof productList>[]>(
    () => [
      {
        id: 'select',
        header: "#",
  ...
  document.title = "Products | Dashwork - React Admin & Dashboard Template";
